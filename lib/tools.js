...
internals.loadTool = function (toolObject) {
    ...
    sofaInternals.docs.tools[toolObject.group].methods[toolObject.name].name = toolObject.name;
    sofaInternals.docs.tools[toolObject.group].methods[toolObject.name].signature = signature;

    // @todo apply markdown rules to comment

    sofaInternals.docs.tools[toolObject.group].methods[toolObject.name].comment = Marked(toolObject.comment);
