...
exports = module.exports =  internals.Utils = function (sofaInternalsParam) {
            ...
            sofaInternals.destroydb()
                    ...
                    internals.context.createdb(function (err, createResponse) {
                        ...
                        if (!err) {
                            ...
                            internals.context.loadDesigns(function (err, loadResponse) {
                                ...
                                console.log('designs loaded: ' + loadResponse);
                            });
                ...
                .catch(function (err) {
                    ...
                    if (err.message === 'missing') {
                        ...
                        internals.context.createdb(function (err, response) {
    ...
    this.destroy = function (documentToDestroy, callback) {

        sofaInternals.db.destroy(documentToDestroy, function (err, result) {
