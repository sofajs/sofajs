...
exports = module.exports = internals.Composer = function (sofaInternalsParam) {
    ...
    this.loadDesigns = function (manifest, composeOptions) {

        // if design exists, update it / reload new.
        //
        // else load design
    ...
    this.reloadDB = function (manifest, composeOptions) {

        // destroy db.
        //
        // reload fixtures and design documents.
        //
        // then compose

        console.log('re-load designs');
        return internals.context;
    };
...
internals.loadTools = function (manifest, composeOptions) {
    ...
    // they should not be composed with live interface.
    if (sofaInternals.live === true) {

        console.log('sofaInternals.live is true!!!');
...
internals.loadRequests = function (manifest, composeOptions) {
    ...
    //
    //     console.log('began connection');
    //     Hoek.assert(err === null, 'sofajs connection failed to be made.');
...
internals.loadDesigns = function (manifest, composeOptions) {
    ...
    // this to be loaded seperately from composer.
