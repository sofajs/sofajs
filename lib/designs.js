    ...
    sofaInternals.design.load = function () {
        ...
        Async.waterfall([
                function (next) {
                    ...
                    console.log('##state '+ sofaInternals.live);
                ...
                function (next) {
                    ...
                    var lookingFor = '_design/'+ internals.designName;
                    ...
                    // sofaInternals.db.get(lookingFor, function(err, body) {

                    //     if (err && err.statusCode === 404) {

                    //         // record does not exist.

                    //         console.log('designRecord record not found');
                    //         console.log(err);
                    ...
                    //         console.log('db.get result: '+ JSON.stringify(body));
                    //         console.log('designRecord record found!! update it');
                    //         console.log('docToLoad: '+ JSON.stringify(internals.designDocumentToLoad));

                    //         var design = internals.designDocumentToLoad;

                    //         // update test

                    //         sofaInternals.db.insert({_id: lookingFor, _rev: body._rev, views: design.views, updates: design.updates }, function (err, body) {
                    ...
                    sofaInternals.tools.core.findById('_design/user', function (err, result) {
                    ...
                    // sofaInternals.tools.core.findById('_design/wawee', function (err, result) {
                    // 
                    //     // this works

                    //     console.log('**findById2**: '+ JSON.stringify(result));
                    //     console.log('async is finished2');
                    // });
