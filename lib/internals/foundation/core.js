    ...
    sofaInternals.foundation.register(internals.foundationGroupName)
        .foundation.requests([
...

            {
                name: 'noparam',
                group: internals.foundationGroupName,
                comment: 'coverage proof foundation function with no parameter.  \n',
                handler: function () {

                    var boom = 'foundation noparam executed';
                    return boom;
                }
            },
...

            {
                name: 'oneparam',
                group: internals.foundationGroupName,
                comment: 'lib/foundation coverage proof with one parameter.  \n',
                handler: function (callback) {

                    var mockVar = 'Jon';
                    return callback(null, mockVar);
                }
            },
